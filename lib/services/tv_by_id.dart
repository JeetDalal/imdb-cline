...
//
//     final tvByIdApi = tvByIdApiFromJson(jsonString);

import 'dart:convert';

TvByIdApi? tvByIdApiFromJson(String str) =>
    TvByIdApi.fromJson(json.decode(str));

String tvByIdApiToJson(TvByIdApi? data) => json.encode(data!.toJson());
...
class TvByIdApi {
  ...
  factory TvByIdApi.fromJson(Map<String, dynamic> json) => TvByIdApi(
        adult: json["adult"],
